        ...
        <>
            ...
            {modal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4 backdrop-blur-sm">
                    <div
                        className={`w-full max-w-sm rounded-2xl border p-8 shadow-2xl ${modal.success ? "border-green-500/30 bg-[#0d1f17]" : "border-red-500/30 bg-[#1f0d0d]"}`}
                    >
                        {/* Icon */}
                        <div
                            className={`mx-auto mb-5 flex size-14 items-center justify-center rounded-full ${modal.success ? "bg-green-500/15" : "bg-red-500/15"}`}
                        >
                            {modal.success ? (
                                <svg
                        ...
                        {/* Title */}
                        <h4
                            className={`font-hanken mb-2 text-center text-lg font-bold ${modal.success ? "text-green-400" : "text-red-400"}`}
                        >
            ...
            <form className="grid grid-cols-1 gap-x-6 gap-y-5 md:grid-cols-2">
                ...
                {/* Full Name */}
                <InputField label="Full Name" faicon={faUser}>
                    <input
                        type="text"
                ...
                {/* Profession */}
                <InputField label="Profession" faicon={faSuitcase}>
                    <input
                        type="text"
                ...
                {/* Email */}
                <InputField label="Email Address" faicon={faMailBulk}>
                    <input
                        type="email"
                ...
                {/* Date of Birth */}
                <InputField label="Date of Birth" faicon={faCalendar}>
                    <input
                        type="date"
                        className={inputClass}
                        onChange={(e) => {
                ...
                {/* City */}
                <InputField label="City" faicon={faCity}>
                    <input
                        type="text"
                        placeholder="London"
                        className={inputClass}
                ...
                {/* Country */}
                <InputField label="Country" faicon={faGlobe}>
                    <input
                        type="text"
