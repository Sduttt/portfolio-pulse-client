        ...
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#10131a]">
            ...
            <div className="mx-4 w-full lg:w-1/2 lg:pr-8">
                ...
                <div className="mt-2 md:flex">
                    <button className="font-hanken mt-4 mr-4 flex w-full cursor-pointer items-center justify-center rounded-lg bg-[#A2BAF0] px-5 py-2 text-base font-bold text-[#10131A] transition hover:bg-[#A2BAF0]/90 md:w-fit lg:px-8 lg:py-4 lg:text-xl">
                        Get Started{" "}
